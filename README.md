...
Character build level % = (current DPS - DPS floor) / (DPS ceiling - DPS floor)
```
...
Upgrade difficulty modifier = 1 - (roll value / 45)
```
...
Priority score = (DPS ceiling - current DPS) * Upgrade difficulty modifier
```
